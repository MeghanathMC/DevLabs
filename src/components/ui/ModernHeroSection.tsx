        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
              Create stunning portfolios that highlight your hackathon projects, achievements, and skills. 
              Stand out to recruiters with professional presentation.
            </p>
          </motion.div>
          ...
          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link 
                to="/portfolio/demo" 
                className="bg-white/10 backdrop-blur-sm text-white border border-white/20 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/20 transition-all duration-300 inline-flex items-center"
              >
                View Demo Portfolio
              </Link>
            </div>
