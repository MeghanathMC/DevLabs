...
const AnimatedLoadingSkeleton = () => {
    ...
    return (
        <motion.div
            className="w-full max-w-4xl mx-auto p-6 bg-bg-secondary rounded-xl shadow-lg border border-indigo-500/20"
            variants={frameVariants}
            initial="hidden"
            animate="visible"
        >
            <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-bg-tertiary to-bg-primary p-8">
                ...
                >
                    <motion.div
                        className="bg-indigo-500/20 p-3 rounded-full backdrop-blur-sm border border-indigo-500/30"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[...Array(config.numCards)].map((_, i) => (
                        <motion.div
                            ...
                            className="bg-bg-secondary rounded-lg shadow-sm p-4 border border-indigo-500/20"
                        >
                            {/* Card placeholders */}
                            <motion.div
                                className="h-32 bg-bg-tertiary rounded-md mb-3"
                                animate={{
                            ...
                            />
                            <motion.div
                                className="h-3 w-3/4 bg-bg-tertiary rounded mb-2"
                                animate={{
                                    background: ["#1a1a1a", "#2a2a2a", "#1a1a1a"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
                            />
                            <motion.div
                                className="h-3 w-1/2 bg-bg-tertiary rounded"
                                animate={{
                                    background: ["#1a1a1a", "#2a2a2a", "#1a1a1a"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
